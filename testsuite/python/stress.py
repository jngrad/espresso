    ...
    def test_fene(self):
        ...
        self.assertTrue(
            np.max(
                np.abs(
                    sim_stress_bonded -
                    total_bonded_stresses)) < tol,
            'bonded stresses do not sum up to the total value')
