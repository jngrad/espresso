...
class Test(ut.TestCase):
    ...
    def check_pbc(self):
        ...
        for le_dir in (-1., +1.):
            ...
            pos_near[0] = [start - le_dir * (eps * 1.0 + vs_dist * 0.0), 1., 1.]
            pos_near[1] = [start + le_dir * (eps * 0.5 + vs_dist * 0.5), 1., 1.]
            pos_near[2] = [start + le_dir * (eps * 2.0 + vs_dist * 1.0), 1. - le_dir * le_offset, 1.]
    ...
    def test_image_box_update(self):
        ...
        virt_part = system.part.add(pos=[0., 0., -self.vs_dist / 2. + 4. * system.box_l[2]], virtual=True)
