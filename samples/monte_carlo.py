...
class MCMethods:
    ...
    def get_random_position_in_box(self):
        ...
        if self.constraint_type == "none":
            ...
            raise NotImplementedError(f"Constraint type {self.constraint_type} is not implemented")
        return position
    ...
    def set_cyl_constraint(self,center_x, center_y,  radius):
        """
        Constrains the MC sampling within a volume given by a cylinder.

        NOTE:
            This function assumes that the cylinder is along the z-axis
