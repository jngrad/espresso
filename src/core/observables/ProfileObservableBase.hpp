 ...
 */
#ifndef OBSERVABLES_PROFILEOBSERVABLEBASE_HPP
#define OBSERVABLES_PROFILEOBSERVABLEBASE_HPP
...
/** Profile observable */
class ProfileObservableBase : virtual public Observable {
protected:
...
public:
  ProfileObservableBase(double min_0, double max_0, double min_1, double max_1,
                        double min_2, double max_2, int n_0_bins, int n_1_bins,
                        int n_2_bins)
