...
template <typename T>
void all_gatherv_impl(boost::mpi::communicator const &comm, T const *in_values,
                      int in_size, T *out_values, int const *sizes,
                      int const *displs, boost::mpl::true_) {
...
iall_gatherv_impl(boost::mpi::communicator const &comm, T const *in_values,
                  int in_size, T *out_values, int const *sizes,
                  int const *displs, boost::mpl::false_) {
...
void all_gatherv_impl(boost::mpi::communicator const &comm, T const *in_values,
                      int in_size, T *out_values, int const *sizes,
                      int const *displs, boost::mpl::false_) {
  auto reqs = iall_gatherv_impl(comm, in_values, in_size, out_values, sizes,
                                displs, boost::mpl::false_{});
...
template <typename T>
void all_gatherv(boost::mpi::communicator const &comm, T const *in_values,
                 int in_size, T *out_values, int const *sizes,
                 int const *displs) {
...
auto iall_gatherv(boost::mpi::communicator const &comm, T const *in_values,
                  int in_size, T *out_values, int const *sizes,
                  int const *displs)
    -> decltype(detail::iall_gatherv_impl(comm, in_values, in_size, out_values,
                                          sizes, displs,
                                          boost::mpi::is_mpi_datatype<T>())) {
  return detail::iall_gatherv_impl(comm, in_values, in_size, out_values, sizes,
                                   displs, boost::mpi::is_mpi_datatype<T>());
}
