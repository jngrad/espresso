...
__launch_bounds__(256) void collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    double *RESTRICT _data_pdfs_10_20_36 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           ...
                                           6 * _stride_pdfs_3;
    const double xi_25 = _data_pdfs_10_20_36[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_318 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        18 * _stride_pdfs_3;
    const double xi_26 = _data_pdfs_10_20_318[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_38 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           8 * _stride_pdfs_3;
    const double xi_27 = _data_pdfs_10_20_38[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_310 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        10 * _stride_pdfs_3;
    const double xi_28 = _data_pdfs_10_20_310[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_313 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        13 * _stride_pdfs_3;
    const double xi_29 = _data_pdfs_10_20_313[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_32 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           2 * _stride_pdfs_3;
    const double xi_30 = _data_pdfs_10_20_32[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_39 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           9 * _stride_pdfs_3;
    const double xi_31 = _data_pdfs_10_20_39[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_315 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        15 * _stride_pdfs_3;
    const double xi_32 = _data_pdfs_10_20_315[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_force_10_20_32 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 +
        2 * _stride_force_3;
    const double xi_33 = _data_force_10_20_32[_stride_force_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_317 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        17 * _stride_pdfs_3;
    const double xi_34 = _data_pdfs_10_20_317[_stride_pdfs_0 * ctr_0];
    ...
    double *RESTRICT _data_pdfs_10_20_314 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        14 * _stride_pdfs_3;
    const double xi_36 = _data_pdfs_10_20_314[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_force_10_20_31 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 +
        _stride_force_3;
    const double xi_37 = _data_force_10_20_31[_stride_force_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_34 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           4 * _stride_pdfs_3;
    const double xi_38 = _data_pdfs_10_20_34[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_311 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        11 * _stride_pdfs_3;
    const double xi_39 = _data_pdfs_10_20_311[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_35 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           5 * _stride_pdfs_3;
    const double xi_40 = _data_pdfs_10_20_35[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_31 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           _stride_pdfs_3;
    const double xi_41 = _data_pdfs_10_20_31[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_37 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           7 * _stride_pdfs_3;
    const double xi_42 = _data_pdfs_10_20_37[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_316 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2 +
        16 * _stride_pdfs_3;
    const double xi_43 = _data_pdfs_10_20_316[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_33 = _data_pdfs + _stride_pdfs_1 * ctr_1 +
                                           _stride_pdfs_2 * ctr_2 +
                                           3 * _stride_pdfs_3;
    const double xi_44 = _data_pdfs_10_20_33[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_pdfs_10_20_30 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_2 * ctr_2;
    const double xi_45 = _data_pdfs_10_20_30[_stride_pdfs_0 * ctr_0];
    double *RESTRICT _data_force_10_20_30 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2;
    const double xi_46 = _data_force_10_20_30[_stride_force_0 * ctr_0];
    const double xi_3 = xi_38;
    const double xi_4 = xi_25;
    const double xi_5 = xi_32;
    const double xi_6 = xi_28;
    const double xi_7 = xi_35;
    const double xi_8 = xi_26;
    const double xi_9 = xi_31;
    const double xi_10 = xi_41;
    const double xi_11 = xi_42;
    const double xi_12 = xi_45;
    const double xi_13 = xi_37;
    const double xi_14 = xi_43;
    const double xi_15 = xi_27;
    const double xi_16 = xi_29;
    const double xi_17 = xi_44;
    const double xi_18 = xi_33;
    const double xi_19 = xi_36;
    const double xi_20 = xi_46;
    const double xi_21 = xi_34;
    const double xi_22 = xi_39;
    const double xi_23 = xi_30;
    const double xi_24 = xi_40;
    ...
    _data_pdfs_10_20_30[_stride_pdfs_0 * ctr_0] = forceTerm_0 + omega_shear * (f_eq_common * 0.33333333333333331 + xi_12 * -1.0) + xi_12;
    _data_pdfs_10_20_31[_stride_pdfs_0 * ctr_0] = forceTerm_1 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_1 * u_1)) + xi_10 * -0.5 + xi_23 * -0.5) + rr_0 * (rho * u_1 * 0.16666666666666666 + xi_10 * -0.5 + xi_23 * 0.5) + xi_10 + ((-1.0 <= grid_size * -1.0 + ((double)(ctr_1))) ? (rho * v_s * (u_0 * 2.0 + v_s) * 0.16666666666666666) : (0.0));
    _data_pdfs_10_20_32[_stride_pdfs_0 * ctr_0] = forceTerm_2 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_1 * u_1)) + xi_10 * -0.5 + xi_23 * -0.5) + rr_0 * (rho * u_1 * -0.16666666666666666 + xi_10 * 0.5 + xi_23 * -0.5) + xi_23 + ((0.0 >= ((double)(ctr_1))) ? (rho * v_s * (u_0 * -2.0 + v_s) * 0.16666666666666666) : (0.0));
    _data_pdfs_10_20_33[_stride_pdfs_0 * ctr_0] = forceTerm_3 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_0 * u_0)) + xi_17 * -0.5 + xi_3 * -0.5) + rr_0 * (rho * u_0 * -0.16666666666666666 + xi_17 * -0.5 + xi_3 * 0.5) + xi_17;
    _data_pdfs_10_20_34[_stride_pdfs_0 * ctr_0] = forceTerm_4 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_0 * u_0)) + xi_17 * -0.5 + xi_3 * -0.5) + rr_0 * (rho * u_0 * 0.16666666666666666 + xi_17 * 0.5 + xi_3 * -0.5) + xi_3;
    _data_pdfs_10_20_35[_stride_pdfs_0 * ctr_0] = forceTerm_5 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_2 * u_2)) + xi_24 * -0.5 + xi_4 * -0.5) + rr_0 * (rho * u_2 * 0.16666666666666666 + xi_24 * -0.5 + xi_4 * 0.5) + xi_24;
    _data_pdfs_10_20_36[_stride_pdfs_0 * ctr_0] = forceTerm_6 + omega_shear * (f_eq_common * 0.16666666666666666 + rho * (-0.1111111111111111 + 0.33333333333333331 * (u_2 * u_2)) + xi_24 * -0.5 + xi_4 * -0.5) + rr_0 * (rho * u_2 * -0.16666666666666666 + xi_24 * 0.5 + xi_4 * -0.5) + xi_4;
    _data_pdfs_10_20_37[_stride_pdfs_0 * ctr_0] = forceTerm_7 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_2 * u_2) + 0.125 * (u0Mu1 * u0Mu1)) + xi_11 * -0.5 + xi_6 * -0.5) + rr_0 * (rho * u0Mu1 * -0.083333333333333329 + xi_11 * -0.5 + xi_6 * 0.5) + xi_11 + ((-1.0 <= grid_size * -1.0 + ((double)(ctr_1))) ? (rho * v_s * (u_0 * -2.0 + u_1 * 3.0 + v_s * -1.0 + 1.0) * 0.083333333333333329) : (0.0));
    ...
    _data_pdfs_10_20_39[_stride_pdfs_0 * ctr_0] = forceTerm_9 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_2 * u_2) + 0.125 * (u0Pu1 * u0Pu1)) + xi_15 * -0.5 + xi_9 * -0.5) + rr_0 * (rho * u0Pu1 * -0.083333333333333329 + xi_15 * 0.5 + xi_9 * -0.5) + xi_9 + ((0.0 >= ((double)(ctr_1))) ? (rho * v_s * (u_0 * 2.0 + u_1 * 3.0 + v_s * -1.0 - 1.0) * 0.083333333333333329) : (0.0));
    _data_pdfs_10_20_310[_stride_pdfs_0 * ctr_0] = forceTerm_10 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_2 * u_2) + 0.125 * (u0Mu1 * u0Mu1)) + xi_11 * -0.5 + xi_6 * -0.5) + rr_0 * (rho * u0Mu1 * 0.083333333333333329 + xi_11 * 0.5 + xi_6 * -0.5) + xi_6 + ((0.0 >= ((double)(ctr_1))) ? (rho * v_s * (u_0 * 2.0 + u_1 * -3.0 + v_s * -1.0 + 1.0) * 0.083333333333333329) : (0.0));
    _data_pdfs_10_20_311[_stride_pdfs_0 * ctr_0] = forceTerm_11 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_0 * u_0) + 0.125 * (u1Pu2 * u1Pu2)) + xi_14 * -0.5 + xi_22 * -0.5) + rr_0 * (rho * u1Pu2 * 0.083333333333333329 + xi_14 * 0.5 + xi_22 * -0.5) + xi_22;
    _data_pdfs_10_20_312[_stride_pdfs_0 * ctr_0] = forceTerm_12 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_0 * u_0) + 0.125 * (u1Mu2 * u1Mu2)) + xi_5 * -0.5 + xi_7 * -0.5) + rr_0 * (rho * u1Mu2 * -0.083333333333333329 + xi_5 * 0.5 + xi_7 * -0.5) + xi_7;
    _data_pdfs_10_20_313[_stride_pdfs_0 * ctr_0] = forceTerm_13 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_1 * u_1) + 0.125 * (u0Mu2 * u0Mu2)) + xi_16 * -0.5 + xi_8 * -0.5) + rr_0 * (rho * u0Mu2 * -0.083333333333333329 + xi_16 * -0.5 + xi_8 * 0.5) + xi_16;
    _data_pdfs_10_20_314[_stride_pdfs_0 * ctr_0] = forceTerm_14 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_1 * u_1) + 0.125 * (u0Pu2 * u0Pu2)) + xi_19 * -0.5 + xi_21 * -0.5) + rr_0 * (rho * u0Pu2 * 0.083333333333333329 + xi_19 * -0.5 + xi_21 * 0.5) + xi_19;
    _data_pdfs_10_20_315[_stride_pdfs_0 * ctr_0] = forceTerm_15 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_0 * u_0) + 0.125 * (u1Mu2 * u1Mu2)) + xi_5 * -0.5 + xi_7 * -0.5) + rr_0 * (rho * u1Mu2 * 0.083333333333333329 + xi_5 * -0.5 + xi_7 * 0.5) + xi_5;
    _data_pdfs_10_20_316[_stride_pdfs_0 * ctr_0] = forceTerm_16 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_0 * u_0) + 0.125 * (u1Pu2 * u1Pu2)) + xi_14 * -0.5 + xi_22 * -0.5) + rr_0 * (rho * u1Pu2 * -0.083333333333333329 + xi_14 * -0.5 + xi_22 * 0.5) + xi_14;
    _data_pdfs_10_20_317[_stride_pdfs_0 * ctr_0] = forceTerm_17 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_1 * u_1) + 0.125 * (u0Pu2 * u0Pu2)) + xi_19 * -0.5 + xi_21 * -0.5) + rr_0 * (rho * u0Pu2 * -0.083333333333333329 + xi_19 * 0.5 + xi_21 * -0.5) + xi_21;
    _data_pdfs_10_20_318[_stride_pdfs_0 * ctr_0] = forceTerm_18 + omega_shear * (f_eq_common * 0.041666666666666664 + rho * (-0.013888888888888888 + 0.041666666666666664 * (u_1 * u_1) + 0.125 * (u0Mu2 * u0Mu2)) + xi_16 * -0.5 + xi_8 * -0.5) + rr_0 * (rho * u0Mu2 * 0.083333333333333329 + xi_16 * 0.5 + xi_8 * -0.5) + xi_8;
  }
}
} // namespace internal_collidesweepdoubleprecisionleesedwardscuda_collidesweepdoubleprecisionleesedwardscuda
