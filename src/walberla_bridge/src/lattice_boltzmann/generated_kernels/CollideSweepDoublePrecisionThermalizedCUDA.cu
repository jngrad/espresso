...
static FUNC_PREFIX __launch_bounds__(256) void collidesweepdoubleprecisionthermalizedcuda_collidesweepdoubleprecisionthermalizedcuda(double *RESTRICT const _data_force, double *RESTRICT _data_pdfs, int64_t const _size_force_0, int64_t const _size_force_1, int64_t const _size_force_2, int64_t const _stride_force_0, int64_t const _stride_force_1, int64_t const _stride_force_2, int64_t const _stride_force_3, int64_t const _stride_pdfs_0, int64_t const _stride_pdfs_1, int64_t const _stride_pdfs_2, int64_t const _stride_pdfs_3, uint32_t block_offset_0, uint32_t block_offset_1, uint32_t block_offset_2, double kT, double omega_bulk, double omega_even, double omega_odd, double omega_shear, uint32_t seed, uint32_t time_step) {
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 && blockDim.y * blockIdx.y + threadIdx.y < _size_force_1 && blockDim.z * blockIdx.z + threadIdx.z < _size_force_2) {
    ...
    const double xi_2 = xi_245 + xi_264;
    const double xi_3 = xi_2 + xi_257;
    const double xi_4 = xi_252 + xi_258 + xi_260;
    const double xi_5 = xi_255 + xi_259;
    const double xi_6 = xi_244 + xi_253;
    const double xi_8 = xi_251 * -1.0;
    const double xi_9 = xi_261 * -1.0;
    const double xi_10 = xi_253 * -1.0;
    const double xi_11 = xi_247 * -1.0;
    const double xi_12 = xi_263 * -1.0;
    const double xi_13 = xi_10 + xi_11 + xi_12;
    const double xi_14 = xi_246 * -1.0;
    const double xi_15 = xi_248 * -1.0;
    const double xi_16 = xi_14 + xi_15;
    const double xi_17 = xi_262 * -1.0;
    const double xi_18 = xi_255 * -1.0;
    const double xi_19 = xi_17 + xi_18;
    const double xi_20 = xi_245 * -1.0;
    const double xi_21 = xi_10 + xi_20;
    const double xi_22 = xi_252 * -1.0;
    const double xi_23 = xi_244 * -1.0;
    const double xi_24 = xi_17 + xi_22 + xi_23 + xi_258;
    const double xi_28 = omega_bulk * 0.5;
    const double xi_29 = xi_256 * 0.16666666666666666;
    const double xi_30 = xi_256 * 0.083333333333333329;
    const double xi_42 = xi_265 * 0.16666666666666666;
    const double xi_43 = xi_265 * 0.083333333333333329;
    const double xi_49 = xi_254 * 0.16666666666666666;
    const double xi_50 = xi_254 * 0.083333333333333329;
    const double xi_55 = omega_shear * 0.041666666666666664;
    const double xi_60 = omega_bulk * 0.041666666666666664;
    const double xi_67 = xi_256 * 0.25;
    const double xi_71 = omega_shear * 0.125;
    const double xi_72 = xi_256 * xi_71;
    const double xi_109 = 2.4494897427831779;
    const double xi_114 = xi_249 * -1.0;
    const double xi_118 = xi_258 * -1.0;
    const double xi_119 = xi_118 + xi_18;
    const double xi_120 = xi_250 * -1.0 + xi_8;
    const double xi_122 = xi_264 * -1.0;
    const double xi_123 = xi_11 + xi_122 + xi_15 + xi_21;
    const double xi_125 = xi_252 * 2.0 + xi_255 * 2.0 + xi_258 * 2.0 + xi_262 * 2.0;
    const double xi_126 = xi_125 + xi_257 * 5.0 + xi_263 * 5.0;
    const double xi_128 = xi_247 * 2.0;
    const double xi_129 = xi_264 * 2.0;
    const double xi_130 = xi_245 * 2.0 + xi_253 * 2.0;
    const double xi_132 = xi_118 + xi_255;
    const double xi_133 = xi_132 + xi_14 + xi_22 + xi_260 + xi_262;
    const double xi_134 = omega_odd * 0.25;
    const double xi_135 = xi_133 * xi_134;
    const double xi_136 = random_5_1 - 0.5;
    const double xi_141 = xi_261 * 2.0;
    const double xi_142 = xi_248 * 2.0;
    const double xi_143 = xi_250 * -2.0 + xi_251 * 2.0;
    ...
    const double xi_166 = xi_122 + xi_247;
    const double xi_167 = xi_12 + xi_166 + xi_20 + xi_253 + xi_257;
    ...
    const double xi_178 = xi_119 + xi_23 + xi_252 + xi_259 + xi_262;
    ...
    const double xi_59 = xi_256 * xi_53;
    const double xi_81 = xi_254 * xi_53;
    const double vel0Term = xi_248 + xi_250 + xi_3;
    const double vel1Term = xi_261 + xi_4;
    const double vel2Term = xi_247 + xi_5;
    const double rho = vel0Term + vel1Term + vel2Term + xi_246 + xi_249 + xi_251 + xi_262 + xi_263 + xi_6;
    ...
    const double xi_95 = u_0 * xi_254;
    const double xi_96 = xi_95 * 0.25;
    const double xi_99 = xi_71 * xi_95;
    const double xi_113 = rho * (u_0 * u_0);
    const double u_1 = xi_0 * (vel1Term + xi_16 + xi_19 + xi_250 + xi_8) + xi_256 * xi_7;
    const double xi_26 = u_1 * xi_256;
    ...
    const double xi_86 = xi_254 * xi_69;
    const double xi_88 = xi_254 * xi_74;
    ...
    const double xi_199 = xi_198 * (u_0 * xi_197 + xi_120 + xi_248 + xi_261);
    const double xi_200 = xi_196 * -1.0 + xi_199 * -1.0;
    const double xi_201 = xi_196 + xi_199;
    const double u_2 = xi_0 * (vel2Term + xi_21 + xi_24 + xi_264) + xi_254 * xi_7;
    const double xi_27 = u_2 * xi_254;
    ...
    const double xi_116 = xi_114 + xi_115 * 0.66666666666666663 + xi_244 * 3.0 + xi_259 * 3.0;
    const double xi_117 = omega_even * (xi_112 * 0.66666666666666663 + xi_113 * 1.6666666666666667 + xi_116 + xi_246 * 3.0 + xi_252 * -3.0 + xi_255 * -3.0 + xi_258 * -3.0 + xi_260 * 3.0 + xi_262 * -3.0);
    const double xi_124 = omega_bulk * (xi_113 + xi_115 + xi_119 + xi_121 + xi_123 + xi_17 + xi_22 + xi_249);
    const double xi_127 = omega_even * (xi_112 * 2.3333333333333335 + xi_116 + xi_126 + xi_245 * -5.0 + xi_246 * -2.0 + xi_247 * -5.0 + xi_253 * -5.0 + xi_260 * -2.0 + xi_264 * -5.0);
    const double xi_131 = omega_even * (xi_114 + xi_115 * 3.0 + xi_126 + xi_128 + xi_129 + xi_130 + xi_244 * -4.0 + xi_246 * 5.0 + xi_248 * -7.0 + xi_250 * -7.0 + xi_251 * -7.0 + xi_259 * -4.0 + xi_260 * 5.0 + xi_261 * -7.0);
    const double xi_156 = xi_115 * -1.0 + xi_259;
    const double xi_157 = omega_shear * (xi_121 + xi_156 + xi_16 + xi_2 + xi_247 + xi_260 * -1.0 + xi_6);
    const double xi_158 = xi_157 * 0.125;
    const double xi_159 = xi_107 * -0.11904761904761904 + xi_131 * -0.01984126984126984;
    const double xi_160 = omega_shear * (xi_112 * -1.0 + xi_113 * 2.0 + xi_120 + xi_123 + xi_125 + xi_156 + xi_244 + xi_246 + xi_257 * -2.0 + xi_260 + xi_263 * -2.0 + xi_9);
    ...
    const double xi_205 = xi_198 * (u_2 * xi_197 + xi_132 + xi_17 + xi_252);
    ...
    _data_pdfs_10_20_30[_stride_pdfs_0 * ctr_0] = forceTerm_0 + xi_107 * 0.14285714285714285 + xi_108 * 0.20000000000000001 + xi_110 * -1.0 + xi_111 * 0.085714285714285715 + xi_117 * 0.10000000000000001 + xi_124 * -0.5 + xi_127 * 0.042857142857142858 + xi_131 * 0.023809523809523808 + xi_249;
    _data_pdfs_10_20_31[_stride_pdfs_0 * ctr_0] = forceTerm_1 + xi_135 * -1.0 + xi_140 * -1.0 + xi_151 + xi_164 + xi_260;
    _data_pdfs_10_20_32[_stride_pdfs_0 * ctr_0] = forceTerm_2 + xi_135 + xi_140 + xi_164 + xi_165 + xi_246;
    _data_pdfs_10_20_33[_stride_pdfs_0 * ctr_0] = forceTerm_3 + xi_168 + xi_170 + xi_175 + xi_176 + xi_263;
    _data_pdfs_10_20_34[_stride_pdfs_0 * ctr_0] = forceTerm_4 + xi_168 * -1.0 + xi_170 * -1.0 + xi_176 + xi_177 + xi_257;
    _data_pdfs_10_20_35[_stride_pdfs_0 * ctr_0] = forceTerm_5 + xi_179 * -1.0 + xi_181 * -1.0 + xi_186 + xi_187 + xi_259;
    _data_pdfs_10_20_36[_stride_pdfs_0 * ctr_0] = forceTerm_6 + xi_179 + xi_181 + xi_187 + xi_188 + xi_244;
    _data_pdfs_10_20_37[_stride_pdfs_0 * ctr_0] = forceTerm_7 + xi_177 + xi_195 + xi_200 + xi_261;
    _data_pdfs_10_20_38[_stride_pdfs_0 * ctr_0] = forceTerm_8 + xi_175 + xi_195 + xi_201 + xi_250;
    _data_pdfs_10_20_39[_stride_pdfs_0 * ctr_0] = forceTerm_9 + xi_177 + xi_201 + xi_202 + xi_251;
    _data_pdfs_10_20_310[_stride_pdfs_0 * ctr_0] = forceTerm_10 + xi_175 + xi_200 + xi_202 + xi_248;
    _data_pdfs_10_20_311[_stride_pdfs_0 * ctr_0] = forceTerm_11 + xi_210 + xi_219 + xi_224 + xi_258;
    _data_pdfs_10_20_312[_stride_pdfs_0 * ctr_0] = forceTerm_12 + xi_219 + xi_225 + xi_226 + xi_255;
    _data_pdfs_10_20_313[_stride_pdfs_0 * ctr_0] = forceTerm_13 + xi_231 + xi_234 + xi_239 + xi_247;
    _data_pdfs_10_20_314[_stride_pdfs_0 * ctr_0] = forceTerm_14 + xi_231 + xi_240 + xi_241 + xi_264;
    _data_pdfs_10_20_315[_stride_pdfs_0 * ctr_0] = forceTerm_15 + xi_224 + xi_226 + xi_242 + xi_252;
    _data_pdfs_10_20_316[_stride_pdfs_0 * ctr_0] = forceTerm_16 + xi_210 + xi_225 + xi_242 + xi_262;
    _data_pdfs_10_20_317[_stride_pdfs_0 * ctr_0] = forceTerm_17 + xi_239 + xi_240 + xi_243 + xi_253;
    _data_pdfs_10_20_318[_stride_pdfs_0 * ctr_0] = forceTerm_18 + xi_234 + xi_241 + xi_243 + xi_245;
  }
}
} // namespace internal_collidesweepdoubleprecisionthermalizedcuda_collidesweepdoubleprecisionthermalizedcuda
