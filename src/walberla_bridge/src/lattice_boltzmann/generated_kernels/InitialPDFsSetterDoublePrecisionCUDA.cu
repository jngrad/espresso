...
static FUNC_PREFIX
__launch_bounds__(256) void initialpdfssetterdoubleprecisioncuda_initialpdfssetterdoubleprecisioncuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x < _size_force_0 &&
    ...
    _data_pdfs_10_20_30[_stride_pdfs_0 * ctr_0] =
        ...
        rho * -0.33333333333333331 * (u_2 * u_2) + rho * 0.33333333333333331;
    ...
    _data_pdfs_10_20_31[_stride_pdfs_0 * ctr_0] =
        ...
        rho * -0.16666666666666666 * (u_2 * u_2) + rho * 0.055555555555555552 +
    ...
    _data_pdfs_10_20_35[_stride_pdfs_0 * ctr_0] =
        ...
        rho * -0.16666666666666666 * (u_0 * u_0) +
        rho * -0.16666666666666666 * (u_1 * u_1) + rho * 0.055555555555555552 +
  ...
  // internal_initialpdfssetterdoubleprecisioncuda_initialpdfssetterdoubleprecisioncuda

void InitialPDFsSetterDoublePrecisionCUDA::run(IBlock *block,
                                               cudaStream_t stream) {
...
void InitialPDFsSetterDoublePrecisionCUDA::runOnCellInterval(
