...
static FUNC_PREFIX
__launch_bounds__(256) void streamsweepdoubleprecisioncuda_streamsweepdoubleprecisioncuda(
  ...
  if (blockDim.x * blockIdx.x + threadIdx.x + 1 < _size_force_0 - 1 &&
    ...
    double *RESTRICT _data_pdfs_1m1_20_31 =
    ...
    double *RESTRICT _data_pdfs_11_20_32 =
        _data_pdfs + _stride_pdfs_1 * ctr_1 + _stride_pdfs_1 +
    ...
    const double momdensity_0 = streamed_13 * -1.0 + streamed_17 * -1.0 +
                                streamed_3 * -1.0 + streamed_7 * -1.0 +
                                streamed_9 * -1.0 + vel0Term;
    const double vel1Term = streamed_1 + streamed_11 + streamed_15 + streamed_7;
    const double momdensity_1 = streamed_10 * -1.0 + streamed_12 * -1.0 +
                                streamed_16 * -1.0 + streamed_2 * -1.0 +
                                streamed_8 + streamed_9 * -1.0 + vel1Term;
    ...
    const double momdensity_2 =
        streamed_11 + streamed_14 + streamed_15 * -1.0 + streamed_16 * -1.0 +
        streamed_17 * -1.0 + streamed_18 * -1.0 + streamed_6 * -1.0 + vel2Term;
    double *RESTRICT _data_force_10_20_30 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2;
    const double u_0 =
        momdensity_0 * ((1.0) / (rho)) +
        0.5 * ((1.0) / (rho)) * _data_force_10_20_30[_stride_force_0 * ctr_0];
    double *RESTRICT _data_force_10_20_31 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 +
        _stride_force_3;
    const double u_1 =
        momdensity_1 * ((1.0) / (rho)) +
        0.5 * ((1.0) / (rho)) * _data_force_10_20_31[_stride_force_0 * ctr_0];
    double *RESTRICT _data_force_10_20_32 =
        _data_force + _stride_force_1 * ctr_1 + _stride_force_2 * ctr_2 +
        2 * _stride_force_3;
    const double u_2 =
        momdensity_2 * ((1.0) / (rho)) +
        0.5 * ((1.0) / (rho)) * _data_force_10_20_32[_stride_force_0 * ctr_0];
    double *RESTRICT _data_velocity_10_20_30 = _data_velocity +
                                               _stride_velocity_1 * ctr_1 +
                                               _stride_velocity_2 * ctr_2;
    _data_velocity_10_20_30[_stride_velocity_0 * ctr_0] = u_0;
    double *RESTRICT _data_velocity_10_20_31 =
           ...
           2) % (((64 < ((_size_force_2 - 2 <
              ...
              : ((int64_t)(_size_force_2 - 2) /
                 (int64_t)((
                    ...
                    1)));
  internal_streamsweepdoubleprecisioncuda_streamsweepdoubleprecisioncuda::
      streamsweepdoubleprecisioncuda_streamsweepdoubleprecisioncuda<<<
